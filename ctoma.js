...
const ADMINS = [1301142907, 453834377, 22566, 5084589177];
...
Проверь десны: Если десны видны, опиши их состояние (здоровый розовый цвет или признаки покраснения/отека).
Сделай заключение: Дай краткий вывод о состоянии зубов и десен в доброжелательном тоне, без сложных медицинских терминов, предложи обратиться к стоматологу для точной оценки.
Ограничение: Укажи в конце: 'Этот анализ носит информационный характер и не заменяет профессиональную диагностику'.
Отвечай в структурированном виде:
...
Не чего не пиши про качество фотографии, работай с тем что есть
        `;
...
Я — ваш виртуальный помощник. Готов помочь вам предварительно оценить состояние ваших зубов,
Отправьте фото зубов, и я помогу их проанализировать.

Фото будет видно только вам, фото не сохраняется ни где и видно только вам в диалоге с ботом
