  ...
  async function analyzeTeethPhoto(imageBase64) {
    try {
        ...
        const response = await openai.chat.completions.create({
            ...
            messages: [{
                role: "system",
                content: `ТЫ - ВЕДУЩИЙ ЭКСПЕРТ В ОБЛАСТИ СТОМАТОЛОГИИ. ТВОЯ ЗАДАЧА - НА ОСНОВЕ ПРЕДОСТАВЛЕННОГО ФОТО сделать предвариьельный анализ СОСТОЯНИЕ ЗУБОВ И ДЁСЕН, а также прикуса и кривости зубов,ПРЕДЛОЖИТЬ РЕКОМЕНДАЦИИ ПО ЕЖЕДНЕВНОМУ УХОДУ. УТОЧНИТЬ если СЛЕДУЕТ ОБРАТИТЬСЯ К СТОМАТОЛОГУ
...
ЧТО НЕ ДЕЛАТЬ
НЕ ДАВАТЬ ОКОНЧАТЕЛЬНЫЙ ДИАГНОЗ.

НЕ ИГНОРИРОВАТЬ ЯВНЫЕ ПРОБЛЕМЫ НА ФОТО.`
            }, {
                role: "user",
                content: [
                    {
                        type: "text",
                        text: `ТЫ - ВЕДУЩИЙ ЭКСПЕРТ В ОБЛАСТИ СТОМАТОЛОГИИ. ТВОЯ ЗАДАЧА - НА ОСНОВЕ ПРЕДОСТАВЛЕННОГО ФОТО сделать предвариьельный анализ СОСТОЯНИЕ ЗУБОВ И ДЁСЕН, а также прикуса и кривости зубов,ПРЕДЛОЖИТЬ РЕКОМЕНДАЦИИ ПО ЕЖЕДНЕВНОМУ УХОДУ. УТОЧНИТЬ если СЛЕДУЕТ ОБРАТИТЬСЯ К СТОМАТОЛОГУ
